...
type Digestedfragment struct {
	...
	// TopStickyend_5prime is any over hang at the 5' end of the coding strand
	// This will be greater than "" if the fragment was generated by cutting with an enzyme which leaves a 5' overhang.
	// The complementary sticky end will be on the BottomStickyend_5prime.
	// If this is not "" this will be the first part of the TopStrand sequence.
	TopStickyend_5prime string

	// BottomStickyend_5prime is any over hang at the 5' end of the complementary strand
	// This may be referred to as an underhang.
	// This will be greater than "" if the fragment was generated by cutting with an enzyme which leaves a 5' overhang.
	// The complementary sticky end will be on the TopStickyend_5prime.
