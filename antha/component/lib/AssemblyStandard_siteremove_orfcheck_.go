...
func _AssemblyStandard_siteremove_orfcheckRequirements() {
	// e.g. are MoClo types valid?
}

// Conditions to run on startup
func _AssemblyStandard_siteremove_orfcheckSetup(_ctx context.Context, _input *AssemblyStandard_siteremove_orfcheckInput) {
}

// The core process for this protocol, with the steps to be performed
// for every input
func _AssemblyStandard_siteremove_orfcheckSteps(_ctx context.Context, _input *AssemblyStandard_siteremove_orfcheckInput, _output *AssemblyStandard_siteremove_orfcheckOutput) {
...
func _AssemblyStandard_siteremove_orfcheckAnalysis(_ctx context.Context, _input *AssemblyStandard_siteremove_orfcheckInput, _output *AssemblyStandard_siteremove_orfcheckOutput) {
}

// A block of tests to perform to validate that the sample was processed correctly
// Optionally, destructive tests can be performed to validate results on a
// dipstick basis
func _AssemblyStandard_siteremove_orfcheckValidation(_ctx context.Context, _input *AssemblyStandard_siteremove_orfcheckInput, _output *AssemblyStandard_siteremove_orfcheckOutput) {
}
func _AssemblyStandard_siteremove_orfcheckRun(_ctx context.Context, input *AssemblyStandard_siteremove_orfcheckInput) *AssemblyStandard_siteremove_orfcheckOutput {
	output := &AssemblyStandard_siteremove_orfcheckOutput{}
	_AssemblyStandard_siteremove_orfcheckSetup(_ctx, input)
	_AssemblyStandard_siteremove_orfcheckSteps(_ctx, input, output)
	_AssemblyStandard_siteremove_orfcheckAnalysis(_ctx, input, output)
	_AssemblyStandard_siteremove_orfcheckValidation(_ctx, input, output)
	return output
}

func AssemblyStandard_siteremove_orfcheckRunSteps(_ctx context.Context, input *AssemblyStandard_siteremove_orfcheckInput) *AssemblyStandard_siteremove_orfcheckSOutput {
	soutput := &AssemblyStandard_siteremove_orfcheckSOutput{}
	output := _AssemblyStandard_siteremove_orfcheckRun(_ctx, input)
...
func AssemblyStandard_siteremove_orfcheckNew() interface{} {
	return &AssemblyStandard_siteremove_orfcheckElement{
		inject.CheckedRunner{
			RunFunc: func(_ctx context.Context, value inject.Value) (inject.Value, error) {
				input := &AssemblyStandard_siteremove_orfcheckInput{}
			...
			In:  &AssemblyStandard_siteremove_orfcheckInput{},
			Out: &AssemblyStandard_siteremove_orfcheckOutput{},
		},
	}
}
...
type AssemblyStandard_siteremove_orfcheckElement struct {
	inject.CheckedRunner
}

type AssemblyStandard_siteremove_orfcheckInput struct {
...
func init() {
	if err := addComponent(component.Component{Name: "AssemblyStandard_siteremove_orfcheck",
		...
		Desc: component.ComponentDesc{
			Desc: "",
			Path: "src/github.com/antha-lang/antha/antha/component/an/Data/DNA/TypeIISAssembly_design/AssemblyStandard_removesites_checkorfs.an",
