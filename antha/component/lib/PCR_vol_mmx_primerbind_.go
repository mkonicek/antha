...
func _PCR_vol_mmx_primerbindRequirements() {

}

// Conditions to run on startup
func _PCR_vol_mmx_primerbindSetup(_ctx context.Context, _input *PCR_vol_mmx_primerbindInput) {
}

// The core process for this protocol, with the steps to be performed
// for every input
func _PCR_vol_mmx_primerbindSteps(_ctx context.Context, _input *PCR_vol_mmx_primerbindInput, _output *PCR_vol_mmx_primerbindOutput) {
...
func _PCR_vol_mmx_primerbindAnalysis(_ctx context.Context, _input *PCR_vol_mmx_primerbindInput, _output *PCR_vol_mmx_primerbindOutput) {
}

// A block of tests to perform to validate that the sample was processed correctly
// Optionally, destructive tests can be performed to validate results on a
// dipstick basis
func _PCR_vol_mmx_primerbindValidation(_ctx context.Context, _input *PCR_vol_mmx_primerbindInput, _output *PCR_vol_mmx_primerbindOutput) {
}
func _PCR_vol_mmx_primerbindRun(_ctx context.Context, input *PCR_vol_mmx_primerbindInput) *PCR_vol_mmx_primerbindOutput {
	output := &PCR_vol_mmx_primerbindOutput{}
	_PCR_vol_mmx_primerbindSetup(_ctx, input)
	_PCR_vol_mmx_primerbindSteps(_ctx, input, output)
	_PCR_vol_mmx_primerbindAnalysis(_ctx, input, output)
	_PCR_vol_mmx_primerbindValidation(_ctx, input, output)
	return output
}

func PCR_vol_mmx_primerbindRunSteps(_ctx context.Context, input *PCR_vol_mmx_primerbindInput) *PCR_vol_mmx_primerbindSOutput {
	soutput := &PCR_vol_mmx_primerbindSOutput{}
	output := _PCR_vol_mmx_primerbindRun(_ctx, input)
...
func PCR_vol_mmx_primerbindNew() interface{} {
	return &PCR_vol_mmx_primerbindElement{
		inject.CheckedRunner{
			RunFunc: func(_ctx context.Context, value inject.Value) (inject.Value, error) {
				input := &PCR_vol_mmx_primerbindInput{}
			...
			In:  &PCR_vol_mmx_primerbindInput{},
			Out: &PCR_vol_mmx_primerbindOutput{},
		},
	}
}
...
type PCR_vol_mmx_primerbindElement struct {
	inject.CheckedRunner
}

type PCR_vol_mmx_primerbindInput struct {
...
type PCR_vol_mmx_primerbindOutput struct {
	FwdPrimerSites []search.Thingfound
	Reaction       *wtype.LHComponent
	RevPrimerSites []search.Thingfound
}

type PCR_vol_mmx_primerbindSOutput struct {
	Data struct {
		FwdPrimerSites []search.Thingfound
		RevPrimerSites []search.Thingfound
	}
...
func init() {
	if err := addComponent(component.Component{Name: "PCR_vol_mmx_primerbind",
		...
		Desc: component.ComponentDesc{
			Desc: "",
			Path: "src/github.com/antha-lang/antha/antha/component/an/Liquid_handling/PCR/pcr_vol_mmx_primerbind.an",
