...
func init() {
	if err := addComponent(component.Component{Name: "TypeIISConstructAssemblyMMX_forscreen_transform",
		...
		Desc: component.ComponentDesc{
			Desc: "",
			Path: "src/github.com/antha-lang/antha/antha/component/an/Liquid_handling/TypeIIsAssembly/TypeIISConstructAssemblyMMX_forscreen/TypeIISConstructAssemblyMMX_transform.an",
