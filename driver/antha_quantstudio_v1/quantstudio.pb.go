...
func (ErrorCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{0}
}
...
func (BlockType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{1}
}
...
func (m *SessionOrError) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SessionOrError.Unmarshal(m, b)
}
func (m *SessionOrError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SessionOrError.Marshal(b, m, deterministic)
}
func (dst *SessionOrError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SessionOrError.Merge(dst, src)
}
func (m *SessionOrError) XXX_Size() int {
	return xxx_messageInfo_SessionOrError.Size(m)
}
func (m *SessionOrError) XXX_DiscardUnknown() {
	xxx_messageInfo_SessionOrError.DiscardUnknown(m)
}

var xxx_messageInfo_SessionOrError proto.InternalMessageInfo
...
type SessionOrError_Blank struct {
	Blank *Blank `protobuf:"bytes,3,opt,name=blank,proto3,oneof"`
}
...
func (*ExperimentFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{2}
}
func (m *ExperimentFile) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ExperimentFile.Unmarshal(m, b)
}
func (m *ExperimentFile) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ExperimentFile.Marshal(b, m, deterministic)
}
func (dst *ExperimentFile) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExperimentFile.Merge(dst, src)
}
func (m *ExperimentFile) XXX_Size() int {
	return xxx_messageInfo_ExperimentFile.Size(m)
}
func (m *ExperimentFile) XXX_DiscardUnknown() {
	xxx_messageInfo_ExperimentFile.DiscardUnknown(m)
}

var xxx_messageInfo_ExperimentFile proto.InternalMessageInfo
...
func (*Barcode) Descriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{3}
}
...
func (dst *Barcode) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Barcode.Merge(dst, src)
}
...
func (*BlockTypeOrError) Descriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{4}
}
func (m *BlockTypeOrError) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_BlockTypeOrError.Unmarshal(m, b)
}
func (m *BlockTypeOrError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_BlockTypeOrError.Marshal(b, m, deterministic)
}
func (dst *BlockTypeOrError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BlockTypeOrError.Merge(dst, src)
}
func (m *BlockTypeOrError) XXX_Size() int {
	return xxx_messageInfo_BlockTypeOrError.Size(m)
}
func (m *BlockTypeOrError) XXX_DiscardUnknown() {
	xxx_messageInfo_BlockTypeOrError.DiscardUnknown(m)
}

var xxx_messageInfo_BlockTypeOrError proto.InternalMessageInfo
...
type BlockTypeOrError_BlockType struct {
	BlockType BlockType `protobuf:"varint,1,opt,name=block_type,json=blockType,proto3,enum=antha.quantstudio.v1.BlockType,oneof"`
}
...
type Error struct {
	Code                 ErrorCode `protobuf:"varint,1,opt,name=code,proto3,enum=antha.quantstudio.v1.ErrorCode" json:"code,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{5}
}
...
func (*OptionalError) Descriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{6}
}
func (m *OptionalError) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_OptionalError.Unmarshal(m, b)
}
func (m *OptionalError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_OptionalError.Marshal(b, m, deterministic)
}
func (dst *OptionalError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OptionalError.Merge(dst, src)
}
func (m *OptionalError) XXX_Size() int {
	return xxx_messageInfo_OptionalError.Size(m)
}
func (m *OptionalError) XXX_DiscardUnknown() {
	xxx_messageInfo_OptionalError.DiscardUnknown(m)
}

var xxx_messageInfo_OptionalError proto.InternalMessageInfo
...
type OptionalError_Blank struct {
	Blank *Blank `protobuf:"bytes,1,opt,name=blank,proto3,oneof"`
}
type OptionalError_Error struct {
	Error ErrorCode `protobuf:"varint,2,opt,name=error,proto3,enum=antha.quantstudio.v1.ErrorCode,oneof"`
}
...
func (*StatusOrError) Descriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{7}
}
func (m *StatusOrError) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_StatusOrError.Unmarshal(m, b)
}
func (m *StatusOrError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_StatusOrError.Marshal(b, m, deterministic)
}
func (dst *StatusOrError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatusOrError.Merge(dst, src)
}
func (m *StatusOrError) XXX_Size() int {
	return xxx_messageInfo_StatusOrError.Size(m)
}
func (m *StatusOrError) XXX_DiscardUnknown() {
	xxx_messageInfo_StatusOrError.DiscardUnknown(m)
}

var xxx_messageInfo_StatusOrError proto.InternalMessageInfo
...
type StatusOrError_Status struct {
	Status ErrorCode `protobuf:"varint,1,opt,name=status,proto3,enum=antha.quantstudio.v1.ErrorCode,oneof"`
}
...
type ExperimentRequest struct {
	SessionInstrument    *SessionInstrument `protobuf:"bytes,1,opt,name=session_instrument,json=sessionInstrument,proto3" json:"session_instrument,omitempty"`
	ExperimentFile       *ExperimentFile    `protobuf:"bytes,2,opt,name=experiment_file,json=experimentFile,proto3" json:"experiment_file,omitempty"`
...
func (*ExperimentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{8}
}
...
func (dst *ExperimentRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExperimentRequest.Merge(dst, src)
}
...
type TemplatedRequest struct {
	SessionInstrument    *SessionInstrument `protobuf:"bytes,1,opt,name=session_instrument,json=sessionInstrument,proto3" json:"session_instrument,omitempty"`
	TemplateFile         *ExperimentFile    `protobuf:"bytes,2,opt,name=template_file,json=templateFile,proto3" json:"template_file,omitempty"`
	Barcode              *Barcode           `protobuf:"bytes,3,opt,name=barcode,proto3" json:"barcode,omitempty"`
...
func (*TemplatedRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{9}
}
func (m *TemplatedRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TemplatedRequest.Unmarshal(m, b)
}
func (m *TemplatedRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TemplatedRequest.Marshal(b, m, deterministic)
}
func (dst *TemplatedRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TemplatedRequest.Merge(dst, src)
}
func (m *TemplatedRequest) XXX_Size() int {
	return xxx_messageInfo_TemplatedRequest.Size(m)
}
func (m *TemplatedRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_TemplatedRequest.DiscardUnknown(m)
}

var xxx_messageInfo_TemplatedRequest proto.InternalMessageInfo
...
func (*BoolOrError) Descriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{10}
}
func (m *BoolOrError) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_BoolOrError.Unmarshal(m, b)
}
func (m *BoolOrError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_BoolOrError.Marshal(b, m, deterministic)
}
func (dst *BoolOrError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BoolOrError.Merge(dst, src)
}
func (m *BoolOrError) XXX_Size() int {
	return xxx_messageInfo_BoolOrError.Size(m)
}
func (m *BoolOrError) XXX_DiscardUnknown() {
	xxx_messageInfo_BoolOrError.DiscardUnknown(m)
}

var xxx_messageInfo_BoolOrError proto.InternalMessageInfo
...
type BoolOrError_Result struct {
	Result bool `protobuf:"varint,1,opt,name=result,proto3,oneof"`
}
...
func (*Session) Descriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{11}
}
...
func (*Instrument) Descriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{12}
}
...
func (*SessionInstrument) Descriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{13}
}
func (m *SessionInstrument) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SessionInstrument.Unmarshal(m, b)
}
func (m *SessionInstrument) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SessionInstrument.Marshal(b, m, deterministic)
}
func (dst *SessionInstrument) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SessionInstrument.Merge(dst, src)
}
func (m *SessionInstrument) XXX_Size() int {
	return xxx_messageInfo_SessionInstrument.Size(m)
}
func (m *SessionInstrument) XXX_DiscardUnknown() {
	xxx_messageInfo_SessionInstrument.DiscardUnknown(m)
}

var xxx_messageInfo_SessionInstrument proto.InternalMessageInfo
...
func (*Credentials) Descriptor() ([]byte, []int) {
	return fileDescriptor_quantstudio_85e079c85ce156b1, []int{14}
}
...
// QuantStudioServiceClient is the client API for QuantStudioService service.
//
...
func (c *quantStudioServiceClient) RunExperiment(ctx context.Context, in *ExperimentRequest, opts ...grpc.CallOption) (*OptionalError, error) {
	...
	err := c.cc.Invoke(ctx, "/antha.quantstudio.v1.QuantStudioService/RunExperiment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quantStudioServiceClient) RunExperimentFromTemplate(ctx context.Context, in *TemplatedRequest, opts ...grpc.CallOption) (*OptionalError, error) {
	out := new(OptionalError)
	err := c.cc.Invoke(ctx, "/antha.quantstudio.v1.QuantStudioService/RunExperimentFromTemplate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quantStudioServiceClient) RunExperimentNonblocking(ctx context.Context, in *ExperimentRequest, opts ...grpc.CallOption) (*OptionalError, error) {
	out := new(OptionalError)
	err := c.cc.Invoke(ctx, "/antha.quantstudio.v1.QuantStudioService/RunExperimentNonblocking", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quantStudioServiceClient) RunExperimentFromTemplateNonblocking(ctx context.Context, in *TemplatedRequest, opts ...grpc.CallOption) (*OptionalError, error) {
	out := new(OptionalError)
	err := c.cc.Invoke(ctx, "/antha.quantstudio.v1.QuantStudioService/RunExperimentFromTemplateNonblocking", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quantStudioServiceClient) OpenTray(ctx context.Context, in *SessionInstrument, opts ...grpc.CallOption) (*OptionalError, error) {
	out := new(OptionalError)
	err := c.cc.Invoke(ctx, "/antha.quantstudio.v1.QuantStudioService/OpenTray", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quantStudioServiceClient) CloseTray(ctx context.Context, in *SessionInstrument, opts ...grpc.CallOption) (*OptionalError, error) {
	out := new(OptionalError)
	err := c.cc.Invoke(ctx, "/antha.quantstudio.v1.QuantStudioService/CloseTray", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quantStudioServiceClient) IsTrayIn(ctx context.Context, in *SessionInstrument, opts ...grpc.CallOption) (*BoolOrError, error) {
	out := new(BoolOrError)
	err := c.cc.Invoke(ctx, "/antha.quantstudio.v1.QuantStudioService/IsTrayIn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quantStudioServiceClient) StartSession(ctx context.Context, in *Credentials, opts ...grpc.CallOption) (*SessionOrError, error) {
	...
	err := c.cc.Invoke(ctx, "/antha.quantstudio.v1.QuantStudioService/StartSession", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quantStudioServiceClient) EndSession(ctx context.Context, in *Session, opts ...grpc.CallOption) (*OptionalError, error) {
	out := new(OptionalError)
	err := c.cc.Invoke(ctx, "/antha.quantstudio.v1.QuantStudioService/EndSession", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quantStudioServiceClient) GetBlockType(ctx context.Context, in *SessionInstrument, opts ...grpc.CallOption) (*BlockTypeOrError, error) {
	...
	err := c.cc.Invoke(ctx, "/antha.quantstudio.v1.QuantStudioService/GetBlockType", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quantStudioServiceClient) GetInstrumentState(ctx context.Context, in *SessionInstrument, opts ...grpc.CallOption) (*StatusOrError, error) {
	...
	err := c.cc.Invoke(ctx, "/antha.quantstudio.v1.QuantStudioService/GetInstrumentState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quantStudioServiceClient) StopCurrentExperiment(ctx context.Context, in *SessionInstrument, opts ...grpc.CallOption) (*OptionalError, error) {
	out := new(OptionalError)
	err := c.cc.Invoke(ctx, "/antha.quantstudio.v1.QuantStudioService/StopCurrentExperiment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// QuantStudioServiceServer is the server API for QuantStudioService service.
...
func init() {
	proto.RegisterFile("github.com/antha-lang/antha/driver/antha_quantstudio_v1/quantstudio.proto", fileDescriptor_quantstudio_85e079c85ce156b1)
}

var fileDescriptor_quantstudio_85e079c85ce156b1 = []byte{
