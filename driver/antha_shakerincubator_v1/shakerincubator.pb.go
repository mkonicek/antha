...
func (*BoolReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_shakerincubator_86d2683d57d3cf69, []int{0}
}
...
func (*ShakerSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_shakerincubator_86d2683d57d3cf69, []int{1}
}
func (m *ShakerSettings) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ShakerSettings.Unmarshal(m, b)
}
func (m *ShakerSettings) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ShakerSettings.Marshal(b, m, deterministic)
}
func (dst *ShakerSettings) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ShakerSettings.Merge(dst, src)
}
func (m *ShakerSettings) XXX_Size() int {
	return xxx_messageInfo_ShakerSettings.Size(m)
}
func (m *ShakerSettings) XXX_DiscardUnknown() {
	xxx_messageInfo_ShakerSettings.DiscardUnknown(m)
}

var xxx_messageInfo_ShakerSettings proto.InternalMessageInfo
...
func (*TemperatureSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_shakerincubator_86d2683d57d3cf69, []int{2}
}
func (m *TemperatureSettings) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TemperatureSettings.Unmarshal(m, b)
}
func (m *TemperatureSettings) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TemperatureSettings.Marshal(b, m, deterministic)
}
func (dst *TemperatureSettings) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TemperatureSettings.Merge(dst, src)
}
func (m *TemperatureSettings) XXX_Size() int {
	return xxx_messageInfo_TemperatureSettings.Size(m)
}
func (m *TemperatureSettings) XXX_DiscardUnknown() {
	xxx_messageInfo_TemperatureSettings.DiscardUnknown(m)
}

var xxx_messageInfo_TemperatureSettings proto.InternalMessageInfo
...
func (*Blank) Descriptor() ([]byte, []int) {
	return fileDescriptor_shakerincubator_86d2683d57d3cf69, []int{3}
}
...
// ShakerIncubatorClient is the client API for ShakerIncubator service.
//
...
func (c *shakerIncubatorClient) Connect(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*BoolReply, error) {
	out := new(BoolReply)
	err := c.cc.Invoke(ctx, "/antha.shakerincubator.v1.ShakerIncubator/Connect", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shakerIncubatorClient) Disconnect(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*BoolReply, error) {
	out := new(BoolReply)
	err := c.cc.Invoke(ctx, "/antha.shakerincubator.v1.ShakerIncubator/Disconnect", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shakerIncubatorClient) Test(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*BoolReply, error) {
	out := new(BoolReply)
	err := c.cc.Invoke(ctx, "/antha.shakerincubator.v1.ShakerIncubator/Test", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shakerIncubatorClient) CarrierOpen(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*BoolReply, error) {
	out := new(BoolReply)
	err := c.cc.Invoke(ctx, "/antha.shakerincubator.v1.ShakerIncubator/CarrierOpen", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shakerIncubatorClient) CarrierClose(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*BoolReply, error) {
	out := new(BoolReply)
	err := c.cc.Invoke(ctx, "/antha.shakerincubator.v1.ShakerIncubator/CarrierClose", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shakerIncubatorClient) ShakeStart(ctx context.Context, in *ShakerSettings, opts ...grpc.CallOption) (*BoolReply, error) {
	out := new(BoolReply)
	err := c.cc.Invoke(ctx, "/antha.shakerincubator.v1.ShakerIncubator/ShakeStart", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shakerIncubatorClient) ShakeStop(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*BoolReply, error) {
	out := new(BoolReply)
	err := c.cc.Invoke(ctx, "/antha.shakerincubator.v1.ShakerIncubator/ShakeStop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shakerIncubatorClient) TemperatureSet(ctx context.Context, in *TemperatureSettings, opts ...grpc.CallOption) (*BoolReply, error) {
	out := new(BoolReply)
	err := c.cc.Invoke(ctx, "/antha.shakerincubator.v1.ShakerIncubator/TemperatureSet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shakerIncubatorClient) TemperatureReset(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*BoolReply, error) {
	out := new(BoolReply)
	err := c.cc.Invoke(ctx, "/antha.shakerincubator.v1.ShakerIncubator/TemperatureReset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ShakerIncubatorServer is the server API for ShakerIncubator service.
...
func init() {
	proto.RegisterFile("github.com/antha-lang/antha/driver/antha_shakerincubator_v1/shakerincubator.proto", fileDescriptor_shakerincubator_86d2683d57d3cf69)
}

var fileDescriptor_shakerincubator_86d2683d57d3cf69 = []byte{
