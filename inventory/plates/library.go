...
func makeBasicPlates(idGen *id.IDGenerator) (plates []*wtype.Plate) {
	...
	plate := wtype.NewLHPlate(idGen, "DSW96", "Unknown", "Unknown", 8, 12, makePlateCoords(44.1), deepsquarewell, 9, 9, 0.0, 0.0, valueformaxheadtonotintoDSWplatewithp20tips)
	...
	plate = wtype.NewLHPlate(idGen, "Nunc96DeepWell", "Unknown", "Unknown", 8, 12, makePlateCoords(43.6), nunc96deepwell, 9, 9, -1.0, 0.0, 6.5)
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "TwistDNAPlate", "Unknown", "Unknown", 8, 12, makePlateCoords(14.4), twist96well, 9.0, 9.0, 0.0, 0.0, -1.9)
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "IDT96", "Unknown", "Unknown", 8, 12, makePlateCoords(42.5), idtroundwell96, 9, 9, 0, 0, 3)
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "FourColumnReservoir", "Unknown", "Unknown", 1, 4, makePlateCoords(44), fourcolumnwell, 26, 1, 9.5, 31, 1) //WellYStart is not accurate, but would not visualise correctly unless set to this value, cant diagnose
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "DSW24", "Unknown", "Unknown", wellspercolumn, wellsperrow, makePlateCoords(heightinmm), squarewell24, wellxoffset, wellyoffset, xstart, ystart, zstart)
	...
	plate = wtype.NewLHPlate(idGen, "SRWFB96", "Unknown", "Unknown", 8, 12, makePlateCoords(15), roundwell96, 9, 9, 0.0, 0.0, 2.2)
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "DWST12", "Unknown", "Unknown", 1, 12, makePlateCoords(44.1), trough12, 9, 9, 0, 30.0, valueformaxheadtonotintoDSWplatewithp20tips)
	//	plate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "SWST12", "Unknown", "Unknown", 1, 12, makePlateCoords(20), trough12s, 9, 9, 0, 30.0, 1)
	//	plate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "DWST8", "Unknown", "Unknown", 8, 1, makePlateCoords(44.1), trough8, 9, 9, 49.5, 0.0, 0.0)
	...
	plate = wtype.NewLHPlate(idGen, "reservoir", "Unknown", "Unknown", 1, 1, makePlateCoords(40), welltypereservoir, 1, 1, 49.5, 31.0, 0.0)
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "falcon6wellAgar", "Unknown", "Unknown", wellspercolumn, wellsperrow, makePlateCoords(heightinmm), welltype6well, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "costar48well", "Unknown", "Unknown", wellspercolumn, wellsperrow, makePlateCoords(heightinmm), welltypecostar48, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "Kombi2mlEpp", "Unknown", "Unknown", 4, 2, makePlateCoords(45), welltype2mleppy, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "eppendorfrack425_2ml", "Unknown", "Unknown", 4, 6, makePlateCoords(45), welltype2mleppy, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "eppendorfrack425_1.5ml", "Unknown", "Unknown", 4, 6, makePlateCoords(plateHeight), welltypesmallereppy, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "eppendorfrack424_2ml_lidholder", "Unknown", "Unknown", 4, 3, makePlateCoords(45), welltype2mleppy, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "eppendorfrack424_1.5ml_lidholder", "Unknown", "Unknown", 4, 3, makePlateCoords(45), welltypesmallereppy, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "greiner384", "Unknown", "Unknown", 16, 24, makePlateCoords(14), welltype384, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "nunc1536", "Unknown", "Unknown", 32, 48, makePlateCoords(7), welltype1536, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "Agarplateforpicking1536", "Unknown", "Unknown", 32, 48, makePlateCoords(7), welltype1536, wellxoffset, wellyoffset, xstart, ystart, zstart)
	...
	// greiner one well with 50ml of agar in
	plate = wtype.NewLHPlate(idGen, "Agarplateforpicking384", "Unknown", "Unknown", 16, 24, makePlateCoords(14), welltype384, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "30mlAgarplateforpicking384", "Unknown", "Unknown", 16, 24, makePlateCoords(14), welltype384, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plates = append(plates, plate)
	...
	// greiner one well with 50ml of agar in
	plate = wtype.NewLHPlate(idGen, "Agarplateforpicking768", "Unknown", "Unknown", 24, 32, makePlateCoords(14), welltype768, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "Agarplateforpicking96", "Unknown", "Unknown", 8, 12, makePlateCoords(14), pcrplatewellforpicking, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "Agarplateforpicking48", "Unknown", "Unknown", 6, 8, makePlateCoords(14), welltypecostar48forpicking, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plate.DeclareSpecial()
	plates = append(plates, plate)

	/// placeholder for non plate container for testing

	plate = wtype.NewLHPlate(idGen, "1L_DuranBottle", "Unknown", "Unknown", 8, 12, makePlateCoords(25.7), welltypereservoir, 9, 9, 0.0, 0.0, 15.5)
	plates = append(plates, plate)
	...
	gelplate := wtype.NewLHPlate(idGen, "EPAGE48", "Invitrogen", "Unknown", 2, 24, makePlateCoords(eplateheight), egelwell, wellxoffset, wellyoffset, xstart, ystart, zstart)
	...
	gelplate = wtype.NewLHPlate(idGen, "EGEL48", "Invitrogen", "Unknown", 2, 24, makePlateCoords(eplateheight), egelwell, wellxoffset, wellyoffset, xstart, ystart, zstart)
	gelplate.SetConstrained("Pipetmax", gelconsar)
	gelplate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, gelplate)
	...
	gelplate = wtype.NewLHPlate(idGen, "EGEL96_1", "Invitrogen", "Unknown", 4, 13, makePlateCoords(48.5), egelwell, 9, 18.0, -9.0, -0.5, riserheightinmm+5.5)
	gelplate.SetConstrained("Pipetmax", gelconsar)
	gelplate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, gelplate)

	// 2nd type
	gelplate = wtype.NewLHPlate(idGen, "EGEL96_2", "Invitrogen", "Unknown", 4, 13, makePlateCoords(48.5), egelwell, 9, 18.0, -5.0, 9, riserheightinmm+5.5)
	gelplate.SetConstrained("Pipetmax", gelconsar)
	gelplate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, gelplate)
	...
	plate = wtype.NewLHPlate(idGen, "Nuncon12wellAgar", "Unknown", "Unknown", wellspercolumn, wellsperrow, makePlateCoords(heightinmm), welltype12well, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, plate)

	// update z start to remove agar estimate and make new plate type
	zstart = 4.0 // offset of bottom of deck to bottom of well
	plate = wtype.NewLHPlate(idGen, "Nuncon12well", "Unknown", "Unknown", wellspercolumn, wellsperrow, makePlateCoords(heightinmm), welltype12well, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "VWR12well", "Unknown", "Unknown", wellspercolumn, wellsperrow, makePlateCoords(heightinmm), welltypevwr12, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plate.DeclareSpecial() // Do this for racks, other very unusual plate types
	plates = append(plates, plate)
	...
	plate = wtype.NewLHPlate(idGen, "nunc8well", "Unknown", "Unknown", wellspercolumn, wellsperrow, makePlateCoords(heightinmm), welltypenunc8, wellxoffset, wellyoffset, xstart, ystart, zstart)
	plate.DeclareSpecial() // Do this for racks, other very unusual plate types
...
func makePCRPlate(idGen *id.IDGenerator) *wtype.Plate {
	return wtype.NewLHPlate(idGen, "pcrplate", "Unknown", "Unknown", 8, 12, makePlateCoords(15.5), makePCRPlateWell(idGen), 9, 9, 0.0, 0.0, MinimumZHeightPermissableForLVPipetMax)
}

// pcr plate semi-skirted
func makeSemiSkirtedPCRPlate(idGen *id.IDGenerator) *wtype.Plate {
	return wtype.NewLHPlate(idGen, "pcrplate_semi_skirted", "Unknown", "Unknown", 8, 12, makePlateCoords(15.5), makePCRPlateWell(idGen), 9, 9, 0.0, 0.0, 1.0)
}

// 0.2ml strip tubes
func makeStripTube(idGen *id.IDGenerator) *wtype.Plate {
	return wtype.NewLHPlate(idGen, "strip_tubes_0.2ml", "Unknown", "Unknown", 8, 12, makePlateCoords(15.5), makePCRPlateWell(idGen), 9, 9, 0.0, 0.0, 0.0)
}

// pcr plate skirted
func makeSkirtedPCRPlate(idGen *id.IDGenerator) *wtype.Plate {
	return wtype.NewLHPlate(idGen, "pcrplate_skirted", "Unknown", "Unknown", 8, 12, makePlateCoords(15.5), makePCRPlateWell(idGen), 9, 9, 0.0, 0.0, MinimumZHeightPermissableForLVPipetMax)
}
...
func makeGreinerVBottomPlate(idGen *id.IDGenerator) *wtype.Plate {
	...
	plate := wtype.NewLHPlate(idGen, "GreinerSWVBottom", "Greiner", "Unknown", 8, 12, makePlateCoords(15), welltype, wellxoffset, wellyoffset, xstart, ystart, zstart)
...
func makeNunc96UPlate(idGen *id.IDGenerator) *wtype.Plate {
	...
	plate := wtype.NewLHPlate(idGen, plateName, manufacturer, partNr, numberOfRows, numberOfColumns, makePlateCoords(overallHeight), welltype, wellxoffset, wellyoffset, xstart, ystart, zstart)
...
func makeGreinerFlatBottomBlackPlate(idGen *id.IDGenerator) *wtype.Plate {
	...
	rwshp := wtype.NewShape(wtype.CylinderShape, "mm", 8.2, 8.2, 11)
	roundwell96 := wtype.NewLHWell(idGen, "ul", 340, 25, rwshp, 0, 8.2, 8.2, 11, 1.0, "mm")
	plate := wtype.NewLHPlate(idGen, wtype.PlateTypeName("greiner96Black"), "greiner", "Unknown", 8, 12, makePlateCoords(15), roundwell96, 9, 9, 0.0, 0.0, 2.0)
	return plate
}
...
func makeHighResplateforPicking(idGen *id.IDGenerator) *wtype.Plate {
	...
	// greiner one well with 50ml of agar in
	plate := wtype.NewLHPlate(idGen, wtype.PlateTypeName("Agarplateforpicking3150"), "Unknown", "Unknown", 45, 70, makePlateCoords(7), welltype3150, wellxoffset, wellyoffset, xstart, ystart, zstart)
...
func make96DeepWellLowVolumePlate(idGen *id.IDGenerator) *wtype.Plate {
	...
	plate := wtype.NewLHPlate(idGen, plateName, manufacturer, partNr, numberOfRows, numberOfColumns, makePlateCoords(overallHeight), newWelltype, wellxoffset, wellyoffset, xstart, ystart, zstart)
