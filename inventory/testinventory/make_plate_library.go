...
func makeBasicPlates() (plates []*wtype.LHPlate) {
	...
	deepsquarewell := wtype.NewLHWell("ul", 2000, 420, swshp, wtype.LHWBV, 8.2, 8.2, 41.3, 4.7, "mm")
	...
	nunc96deepwell := wtype.NewLHWell("ul", 2000, 420, nunc96deepwellshp, wtype.LHWBU, 8.2, 8.2, 41.3, 2.5, "mm")
	...
	twist96well := wtype.NewLHWell("ul", 450, 10, twist96wellshp, wtype.LHWBV, 6.7, 6.7, 9.8, 4.6, "mm")
	...
	idtroundwell96 := wtype.NewLHWell("ul", 1200, 100, idtshp, wtype.LHWBU, 7, 7, 39.35, 3, "mm")
	...
	fourcolumnwell := wtype.NewLHWell("ul", 73000, 3000, fourcolumnshp, wtype.LHWBV, 26, 71, 42, 2, "mm")
	...
	plate = wtype.NewLHPlate("SRWFB96", "Unknown", 8, 12, 15, "mm", roundwell96, 9, 9, 0.0, 0.0, 2.2)
	plates = append(plates, plate)

	// deep well strip trough 12
	stshp := wtype.NewShape("box", "mm", 8.2, 72, 41.3)
	trough12 := wtype.NewLHWell("ul", 15000, 5000, stshp, wtype.LHWBV, 8.2, 72, 41.3, 4.7, "mm")
	...
	trough8 := wtype.NewLHWell("ul", 24000, 1000, stshp8, wtype.LHWBV, 115, 8.2, 41.3, 4.7, "mm")
	...
	welltypereservoir := wtype.NewLHWell("ul", 200000, 40000, reservoirbox, wtype.LHWBFLAT, 121, 80, 40, 3, "mm")
	...
	pcrplatewell := wtype.NewLHWell("ul", 200, 5, cone, wtype.LHWBU, 5.5, 5.5, 15, 1.4, "mm")
	...
	pcrplatewellinc := wtype.NewLHWell("ul", 200, 5, cone, wtype.LHWBU, 5.5, 5.5, 1.55, 1.4, "mm")
	...
	welltype2mleppy := wtype.NewLHWell("ul", 2000, 25, eppy, wtype.LHWBV, 8.2, 8.2, 45, 4.7, "mm")
	...
	welltypesmallereppy := wtype.NewLHWell("ul", 1500, 50, eppy, wtype.LHWBV, 8.2, 8.2, 45, 4.7, "mm")
	...
	pcrplatewellforpicking := wtype.NewLHWell("ul", 5, 1, cone, wtype.LHWBU, xdim, ydim, zdim, bottomh, "mm")
	...
	egelwell := wtype.NewLHWell("ul", 20, 0, ep48g, wtype.LHWBFLAT, xdim, ydim, zdim, bottomh, "mm")
