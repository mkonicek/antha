...
func makeTecanTipBoxes(idGen *id.IDGenerator) []*wtype.LHTipbox {
	...
	tb := wtype.NewLHTipbox(idGen, 8, 12, getTipboxSize(), "Tecan", "30000631", "DiTi 1000uL LiHa", tip, w, 9.0, 9.0, XOffset, YOffset, 28.93)
	ret = append(ret, tb)
	...
	tb = wtype.NewLHTipbox(idGen, 8, 12, getTipboxSize(), "Tecan", "30000627", "DiTi 200uL LiHa", tip, w, 9.0, 9.0, XOffset, YOffset, 28.93)
	ret = append(ret, tb)
	...
	tb = wtype.NewLHTipbox(idGen, 8, 12, getTipboxSize(), "Tecan", "30032115", "DiTi 50uL LiHa", tip, w, 9.0, 9.0, XOffset, YOffset, 28.93)
	ret = append(ret, tb)
	...
	tb = wtype.NewLHTipbox(idGen, 8, 12, getTipboxSize(), "Tecan", "30104803", "DiTi 10uL LiHa", tip, w, 9.0, 9.0, XOffset, YOffset, 28.93)
	ret = append(ret, tb)
