...
func (tree *ITree) Generate(labEffects *effects.LaboratoryEffects, lhpr *wtype.LHPolicyRuleSet, lhpm *LHProperties) error {
	...
	for _, child := range tree.children {
		if err := child.Generate(labEffects, lhpr, lhpm); err != nil {
			return err
		}
	}
