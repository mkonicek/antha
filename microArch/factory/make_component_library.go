...
func makeComponentLibrary() (map[string]*wtype.LHComponent, error) {
	...
	add("gin", wtype.LTMultiWater, 9999)
	add("whisky", wtype.LTMultiWater, 9999)
	add("brandy", wtype.LTMultiWater, 9999)
	add("sambuca", wtype.LTMultiWater, 9999)
	add("rum", wtype.LTMultiWater, 9999)
	add("vodka", wtype.LTMultiWater, 9999)
	add("grappa", wtype.LTMultiWater, 9999)
	add("kahluha", wtype.LTMultiWater, 9999)
