		...
		},
		{
			...
			Instructions: func(ctx context.Context) []*wtype.LHInstruction {
				...
				return []*wtype.LHInstruction{
					getTestMix([]*wtype.Liquid{mixer.Sample(source, wunit.NewVolume(100.0, "ul"))}, "A1"),
					getTestMix([]*wtype.Liquid{mixer.Sample(source, wunit.NewVolume(100.0, "ul"))}, "C1"),
					getTestMix([]*wtype.Liquid{mixer.Sample(source, wunit.NewVolume(100.0, "ul"))}, "E1"),
					getTestMix([]*wtype.Liquid{mixer.Sample(source, wunit.NewVolume(100.0, "ul"))}, "G1"),
				}
			},
			InputPlates:  []*wtype.LHPlate{GetTroughForTest()},
			OutputPlates: []*wtype.LHPlate{GetPlateForTest()},
